...
INSERT INTO COUNTRIES.COUNTRIES (COUNTRY_ID, COUNTRY_NAME, NATIONALITY, COUNTRY_CODE, ISO_ALPHA2, CAPITAL, POPULATION, AREA_KM2, REGION_ID, SUB_REGION_ID)
VALUES
...
INSERT INTO COUNTRIES.REGIONS(ID,REGION_NAME)VALUES
	(10, 'America'),
    (20, 'Europe'),
    (30, 'Asia'),
    (40, 'Oceania'),
...
CREATE TABLE COUNTRIES.SUB_REGIONS(
			ID INT,
            SUB_REGIONS_NAME VARCHAR(255)
            );
            
INSERT INTO COUNTRIES.SUB_REGIONS(ID,SUB_REGIONS_NAME)VALUES
...
SELECT ID,REGION_NAME FROM COUNTRIES.REGIONS;
    
SELECT ID FROM COUNTRIES.REGIONS;
    
SELECT ID,ID,REGION_NAME FROM COUNTRIES.REGIONS;
    
-- ANOTHER WAY 
USE COUNTRIES;
SELECT ID FROM REGIONS;
    
-- DISPLAY ALL COLUMNS IN COUNTRIES AS WELL AS TAKE COUNTRY_ID AGAIN AS A COLUMN
SELECT *,COUNTRY_ID FROM COUNTRIES;
    
    
-- ALIASING FOR COLUMNS ID AS ID_REGION (DOES NOT CHHANGE ACTUAL COLUMN NAME)
SELECT ID AS ID_REGION FROM REGIONS; -- (WITH AS KEYWORD)
SELECT CAPITAL CAPITAL_CITY FROM COUNTRIES; -- (WITHOUT AS KEYWORD)
SELECT CAPITAL AS 'CAPITAL CITY' FROM COUNTRIES; -- (IF DONT WANT UNDESCORE FOR COLUMN NAMES THEN TAKE DOUBLE QUOTES)
    
    
-- ALIASING FOR TABLES
SELECT T1.COUNTRY_ID,T1.COUNTRY_NAME FROM COUNTRIES AS T1;  -- (WITH AS KEYWORD)
SELECT T1.COUNTRY_ID,T1.COUNTRY_NAME FROM COUNTRIES T1;  -- (WITHOUT AS KEYWORD)
    
    
/*
SELECCT DISTINCT COLUMNS FROM TABLE   (DO NOT CONSIDER DUPLICTES)
*/
SELECT REGION_ID FROM COUNTRIES;  -- (249 ROWS RETURNED)
SELECT DISTINCT REGION_ID FROM COUNTRIES;  -- (5 ROWS RETURNED)
SELECT DISTINCT * FROM COUNTRIES; -- (CONSIDER WHOLE ROW SHOULD HAVE DIFFERENT VALUES)
...
*/
SELECT * FROM COUNTRIES ORDER BY REGION_ID; -- (BY DEFAULT ASC)
SELECT * FROM COUNTRIES ORDER BY REGION_ID DESC; -- (DESC ORDER)
SELECT COUNTRY_ID,REGION_ID FROM COUNTRIES ORDER BY COUNTRY_ID;
SELECT COUNTRY_ID,REGION_ID FROM COUNTRIES ORDER BY COUNTRY_ID,REGION_ID;
SELECT REGION_ID,COUNTRY_ID FROM COUNTRIES ORDER BY REGION_ID DESC,COUNTRY_ID ASC;
...
LIMIT O,N
*/
SELECT * FROM COUNTRIES;           -- (249 ROWS RETURNED)
SELECT * FROM COUNTRIES LIMIT 10;  -- (FIRST 10 ROWS RETURNED)
SELECT * FROM COUNTRIES LIMIT 10,10; -- (10 TO 20 IE 10 ROWS RETURNED)
